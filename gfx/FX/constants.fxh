...
static const float MUD_STRENGHTEN 				= 0.5; // WW 1.0
...
static const float COLORMAP_OVERLAY_STRENGTH 	= 0.60f; // WW 0.75
...
static const float  WATER_TIME_SCALE			= 1.0f / 80.0f; // WW 1.0/50.0
...
static const float 	FOG_MAX 					= 0.0f; // WW 0.35
...
static const float GB_CAM_MIN = 220.0f; //DH 150.0f;
static const float GB_CAM_MAX = 225.0f; //DH 350.0f;
